...
export const translations = {
  en: {
    ...
    promptBar: {
        ...
        parallelMode: 'Parallel Generation',
        serialMode: 'Serial Generation',
    },
    ...
    settings: {
        ...
        apiBaseUrlPlaceholder: 'Default: generativelanguage.googleapis.com',
  ...
  zho: {
    ...
    promptBar: {
        ...
        imageSize: '图片尺寸',
        aspectRatioAuto: '自动',
        parallelMode: '并行生成（快，易限流）',
        serialMode: '串行生成（稳定，排队慢）',
    },
    ...
    settings: {
        ...
        apiBaseUrl: 'API 地址',
        apiBaseUrlPlaceholder: '默认: generativelanguage.googleapis.com',
        apiKeyRequired: '请先在设置中配置您的 API Key。',
    },
    contextMenu: {
        copy: '复制',
